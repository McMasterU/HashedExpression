{ lib, stdenv, fetchurl, unzip, blas, lapack, gfortran, mpi, pkgconfig, mumps }:
...
stdenv.mkDerivation rec {
  ...
  CXXDEFS = [ "-DHAVE_RAND" "-DHAVE_CSTRING" "-DHAVE_CSTDIO" "-DHAVE_MPI_INITIALIZED" ];
  ...
  buildInputs = [ gfortran blas lapack mumps mpi ];
