...
import HashedConvZip --for the R2Star tests
import qualified Polynomials as P --for polynomial tests; qualified to avoid conflicts with x
import HashedDot --for polynomial tests
-- import R2Star
--import Maybe (isJust)
...
simpTest10_6 = simplify (xRe (projSS subA ((x1+z1) +: y1))) == projSS subA (x1+z1)
simpTest10_7 = simplify (xRe (projSS subA ((x1+z1) +: y1))) == projSS subA (x1+z1)
...
simpTest10_14 = simplify (xRe (projSS subA (x*.x1 +: y1))) == x*.projSS subA x1
...
regressionTestSimp0 = sequence [putStrLn "simpTest0_0", print simpTest0_0
        , putStrLn "simpTest0_1", print simpTest0_1
        , putStrLn "simpTest0_2", print simpTest0_2
        , putStrLn "simpTest0_3", print simpTest0_3
        , putStrLn "simpTest0_4", print simpTest0_4
        , putStrLn "simpTest0_5", print simpTest0_5
        , putStrLn "simpTest0_6", print simpTest0_6
        , putStrLn "simpTest0_7", print simpTest0_7
        , putStrLn "simpTest0_8", print simpTest0_8
        , putStrLn "simpTest0_9", print simpTest0_9
        , putStrLn "simpTest0_10", print simpTest0_10
        , putStrLn "simpTest0_11", print simpTest0_11
        , putStrLn "simpTest0_12", print simpTest0_12
        , putStrLn "simpTest0_13", print simpTest0_13
        , putStrLn "simpTest0_14", print simpTest0_14
        , putStrLn "simpTest0_15", print simpTest0_15
        , putStrLn "simpTest0_16", print simpTest0_16
        , putStrLn "simpTest0_17", print simpTest0_17
        , putStrLn "simpTest0_18", print simpTest0_18
        ]
regressionTestSimp1 = sequence [putStrLn "simpTest1_0", print simpTest1_0
        , putStrLn "simpTest1_1", print simpTest1_1
        , putStrLn "simpTest1_2", print simpTest1_2
        , putStrLn "simpTest1_3", print simpTest1_3
        , putStrLn "simpTest1_4", print simpTest1_4
        , putStrLn "simpTest1_5", print simpTest1_5
        , putStrLn "simpTest1_6", print simpTest1_6
        , putStrLn "simpTest1_7", print simpTest1_7
        , putStrLn "simpTest1_8", print simpTest1_8
        , putStrLn "simpTest1_9", print simpTest1_9
        , putStrLn "simpTest1_10", print simpTest1_10
        ]
regressionTestSimp2 = sequence [putStrLn "simpTest2_0", print simpTest2_0
        , putStrLn "simpTest2_1", print simpTest2_1
        , putStrLn "simpTest2_2", print simpTest2_2
        , putStrLn "simpTest2_3", print simpTest2_3
        , putStrLn "simpTest2_4", print simpTest2_4
        , putStrLn "simpTest2_5", print simpTest2_5
        , putStrLn "simpTest2_6", print simpTest2_6
        , putStrLn "simpTest2_7", print simpTest2_7
        , putStrLn "simpTest2_8", print simpTest2_8
        ]
regressionTestSimp3 = sequence [putStrLn "simpTest3_0", print simpTest3_0
        , putStrLn "simpTest3_1", print simpTest3_1
        --, putStrLn "simpTest3_2", print simpTest3_2
        --, putStrLn "simpTest3_3", print simpTest3_3
        --, putStrLn "simpTest3_4", print simpTest3_4
        , putStrLn "simpTest3_5", print simpTest3_5
        , putStrLn "simpTest3_6", print simpTest3_6
        , putStrLn "simpTest3_7", print simpTest3_7
        --, putStrLn "simpTest3_8", print simpTest3_8
        , putStrLn "simpTest3_9", print simpTest3_9
        , putStrLn "simpTest3_10", print simpTest3_10
        , putStrLn "simpTest3_11", print simpTest3_11
        , putStrLn "simpTest3_12", print simpTest3_12
        --, putStrLn "simpTest3_13", print simpTest3_13
        --, putStrLn "simpTest3_14", print simpTest3_14
        ]
regressionTestSimp4 = sequence [putStrLn "simpTest4_0", print simpTest4_0
        , putStrLn "simpTest4_1", print simpTest4_1
        , putStrLn "simpTest4_2", print simpTest4_2
        ]
regressionTestSimp5 = sequence [putStrLn "simpTest5_0", print simpTest5_0
        , putStrLn "simpTest5_1", print simpTest5_1
        , putStrLn "simpTest5_2", print simpTest5_2
        , putStrLn "simpTest5_3", print simpTest5_3
        , putStrLn "simpTest5_4", print simpTest5_4
        , putStrLn "simpTest5_5", print simpTest5_5
        , putStrLn "simpTest5_6", print simpTest5_6
        , putStrLn "simpTest5_7", print simpTest5_7
        , putStrLn "simpTest5_8", print simpTest5_8
        , putStrLn "simpTest5_9", print simpTest5_9
        , putStrLn "simpTest5_10", print simpTest5_10
        , putStrLn "simpTest5_11", print simpTest5_11
        , putStrLn "simpTest5_12", print simpTest5_12
        , putStrLn "simpTest5_13", print simpTest5_13
        , putStrLn "simpTest5_14", print simpTest5_14
        , putStrLn "simpTest5_15", print simpTest5_15
        --, putStrLn "simpTest5_16", print simpTest5_16
        , putStrLn "simpTest5_17", print simpTest5_17
        , putStrLn "simpTest5_18", print simpTest5_18
        , putStrLn "simpTest5_19", print simpTest5_19
        , putStrLn "simpTest5_20", print simpTest5_20
        , putStrLn "simpTest5_21", print simpTest5_21
        , putStrLn "simpTest5_22", print simpTest5_22
        , putStrLn "simpTest5_23", print simpTest5_23
        , putStrLn "simpTest5_24", print simpTest5_24
        , putStrLn "simpTest5_25", print simpTest5_25
        , putStrLn "simpTest5_26", print simpTest5_26
        , putStrLn "simpTest5_27", print simpTest5_27
        , putStrLn "simpTest5_28", print simpTest5_28
        , putStrLn "simpTest5_29", print simpTest5_29
        ]
regressionTestSimp6 = sequence [putStrLn "simpTest6_0", print simpTest6_0
        , putStrLn "simpTest6_1", print simpTest6_1
        , putStrLn "simpTest6_2", print simpTest6_2
        , putStrLn "simpTest6_3", print simpTest6_3
        , putStrLn "simpTest6_4", print simpTest6_4
        , putStrLn "simpTest6_5", print simpTest6_5
        , putStrLn "simpTest6_6", print simpTest6_6
        , putStrLn "simpTest6_7", print simpTest6_7
        , putStrLn "simpTest6_8", print simpTest6_8
        , putStrLn "simpTest6_9", print simpTest6_9
        , putStrLn "simpTest6_10", print simpTest6_10
        , putStrLn "simpTest6_11", print simpTest6_11
        , putStrLn "simpTest6_12", print simpTest6_12
        , putStrLn "simpTest6_13", print simpTest6_13
        , putStrLn "simpTest6_14", print simpTest6_14
        , putStrLn "simpTest6_15", print simpTest6_15
        , putStrLn "simpTest6_16", print simpTest6_16
        , putStrLn "simpTest6_17", print simpTest6_17
        , putStrLn "simpTest6_18", print simpTest6_18
        ]
regressionTestSimp7 = sequence [putStrLn "simpTest7_0", print simpTest7_0
        , putStrLn "simpTest7_1", print simpTest7_1
        , putStrLn "simpTest7_2", print simpTest7_2
        , putStrLn "simpTest7_3", print simpTest7_3
        , putStrLn "simpTest7_4", print simpTest7_4
        , putStrLn "simpTest7_5", print simpTest7_5
        , putStrLn "simpTest7_6", print simpTest7_6
        , putStrLn "simpTest7_7", print simpTest7_7
        , putStrLn "simpTest7_8", print simpTest7_8
        , putStrLn "simpTest7_9", print simpTest7_9
        , putStrLn "simpTest7_10", print simpTest7_10
        --, putStrLn "simpTest7_11", print simpTest7_11
        --, putStrLn "simpTest7_12", print simpTest7_12
        --, putStrLn "simpTest7_13", print simpTest7_13
        , putStrLn "simpTest7_14", print simpTest7_14
        , putStrLn "simpTest7_15", print simpTest7_15
        , putStrLn "simpTest7_16", print simpTest7_16
        , putStrLn "simpTest7_17", print simpTest7_17
        , putStrLn "simpTest7_18", print simpTest7_18
        , putStrLn "simpTest7_19", print simpTest7_19
        , putStrLn "simpTest7_20", print simpTest7_20
        , putStrLn "simpTest7_21", print simpTest7_21
        , putStrLn "simpTest7_22", print simpTest7_22
        , putStrLn "simpTest7_23", print simpTest7_23
        , putStrLn "simpTest7_24", print simpTest7_24
        , putStrLn "simpTest7_25", print simpTest7_25
        , putStrLn "simpTest7_26", print simpTest7_26
        , putStrLn "simpTest6_27", print simpTest7_27
        , putStrLn "simpTest7_28", print simpTest7_28
        , putStrLn "simpTest7_29", print simpTest7_29
        , putStrLn "simpTest7_30", print simpTest7_30
        --, putStrLn "simpTest7_31", print simpTest7_31
        , putStrLn "simpTest7_32", print simpTest7_32
        , putStrLn "simpTest7_33", print simpTest7_33
        , putStrLn "simpTest7_34", print simpTest7_34
        , putStrLn "simpTest7_35", print simpTest7_35
        , putStrLn "simpTest7_36", print simpTest7_36
        , putStrLn "simpTest7_37", print simpTest7_37
        ]
regressionTestSimp8 = sequence [putStrLn "simpTest8_0", print simpTest8_0
        , putStrLn "simpTest8_1", print simpTest8_1
        , putStrLn "simpTest8_2", print simpTest8_2
        , putStrLn "simpTest8_3", print simpTest8_3
        , putStrLn "simpTest8_4", print simpTest8_4
        , putStrLn "simpTest8_5", print simpTest8_5
        , putStrLn "simpTest8_6", print simpTest8_6
        , putStrLn "simpTest8_7", print simpTest8_7
        , putStrLn "simpTest8_8", print simpTest8_8
        , putStrLn "simpTest8_9", print simpTest8_9
        , putStrLn "simpTest8_10", print simpTest8_10
        ]
regressionTestSimp9 = sequence [putStrLn "simpTest9_0", print simpTest9_0
        --, putStrLn "simpTest9_1", print simpTest9_1
        --, putStrLn "simpTest9_2", print simpTest9_2
        , putStrLn "simpTest9_3", print simpTest9_3
        , putStrLn "simpTest9_4", print simpTest9_4
        , putStrLn "simpTest9_5", print simpTest9_5
        , putStrLn "simpTest9_6", print simpTest9_6
        , putStrLn "simpTest9_7", print simpTest9_7
        , putStrLn "simpTest9_8", print simpTest9_8
        , putStrLn "simpTest9_9", print simpTest9_9
        , putStrLn "simpTest9_10", print simpTest9_10
        , putStrLn "simpTest9_11", print simpTest9_11
        , putStrLn "simpTest9_12", print simpTest9_12
        , putStrLn "simpTest9_13", print simpTest9_13
        , putStrLn "simpTest9_14", print simpTest9_14
        --, putStrLn "simpTest9_15", print simpTest9_15
        , putStrLn "simpTest9_16", print simpTest9_16
        , putStrLn "simpTest9_17", print simpTest9_17
        , putStrLn "simpTest9_18", print simpTest9_18
        , putStrLn "simpTest9_19", print simpTest9_19
        , putStrLn "simpTest9_20", print simpTest9_20
        , putStrLn "simpTest9_21", print simpTest9_21
        ]
regressionTestSimp10 = sequence [putStrLn "simpTest10_0", print simpTest10_0
        , putStrLn "simpTest10_1", print simpTest10_1
        , putStrLn "simpTest10_2", print simpTest10_2
        , putStrLn "simpTest10_3", print simpTest10_3
        , putStrLn "simpTest10_4", print simpTest10_4
        , putStrLn "simpTest10_5", print simpTest10_5
        , putStrLn "simpTest10_6", print simpTest10_6
        , putStrLn "simpTest10_7", print simpTest10_7
        , putStrLn "simpTest10_8", print simpTest10_8
        , putStrLn "simpTest10_9", print simpTest10_9
        , putStrLn "simpTest10_10", print simpTest10_10 
        ]

--Run all QuickCheck Tests through regressionTest
regressionTestAll = sequence [regressionTestSimp, regressionTestEval, regressionTestPartDiff]

regressionTestEval = sequence [regressionTestEval1]
regressionTestEval1 = sequence [ putStrLn "evalTest0_0", quickCheck evalTest0_0
                          , putStrLn "evalTest0_1", quickCheck evalTest0_1
                          , putStrLn "evalTest0_2", quickCheck evalTest0_2 
                          , putStrLn "evalTest0_3", quickCheck evalTest0_3 
                          , putStrLn "evalTest0_4", quickCheck evalTest0_4 
                          , putStrLn "evalTest0_5", quickCheck evalTest0_5 
                          , putStrLn "evalTest0_1b", quickCheck evalTest0_1b 
                          , putStrLn "evalTest0_7", quickCheck evalTest0_7
                          , putStrLn "evalTest0_8", quickCheck evalTest0_8  
                          , putStrLn "evalTest1_0", quickCheck evalTest1_0
                          , putStrLn "evalTest1_1", quickCheck evalTest1_1
                          , putStrLn "evalTest1_2", quickCheck evalTest1_2 
                          , putStrLn "evalTest1_3", quickCheck evalTest1_3 
                          , putStrLn "evalTest1_4", quickCheck evalTest1_4 
                          , putStrLn "evalTest1_5", quickCheck evalTest1_5 
                          , putStrLn "evalTest1_6", quickCheck evalTest1_6 
                          , putStrLn "evalTest1_7", quickCheck evalTest1_7
                          , putStrLn "evalTest1_8", quickCheck evalTest1_8
                          , putStrLn "evalTest2_0", quickCheck evalTest2_0
                          , putStrLn "evalTest2_1", quickCheck evalTest2_1
                          , putStrLn "evalTest2_2", quickCheck evalTest2_2 
                          , putStrLn "evalTest2_3", quickCheck evalTest2_3 
                          , putStrLn "evalTest2_4", quickCheck evalTest2_4 
--                          , putStrLn "evalTest2_5", quickCheck evalTest2_5 
    --                      , putStrLn "evalTest2_6", quickCheck evalTest2_6 
                          , putStrLn "evalTest2_7", quickCheck evalTest2_7
                          , putStrLn "evalTest2_8", quickCheck evalTest2_8 
                          , putStrLn "evalTest3_0", quickCheck evalTest3_0
                          , putStrLn "evalTest3_1", quickCheck evalTest3_1
                          , putStrLn "evalTest3_2", quickCheck evalTest3_2 
                          , putStrLn "evalTest3_3", quickCheck evalTest3_3 
                          , putStrLn "evalTest3_4", quickCheck evalTest3_4 
                          , putStrLn "evalTest3_5", quickCheck evalTest3_5 
                          , putStrLn "evalTest3_6", quickCheck evalTest3_6 
                          , putStrLn "evalTest3_7", quickCheck evalTest3_7
...
subs1 = subs ([("x",1),("y",2),("z",3),("u",7),("v",11)]
   ...
   ,[],[],[])
subs2 = subs ([("x",1),("y",2),("z",3),("u",7),("v",11)],[]
...
evalTest0_0 n m o = evalScalar x  (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == n
evalTest0_1 n m o = evalScalar (-x) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == negate n
evalTest0_2 n m o = evalScalar (x+y) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == n+m
evalTest0_3 n m o = evalScalar (x+x+x) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == 3*n
evalTest0_4 n m o = evalScalar (2*x) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == n+n
evalTest0_5 n m o = evalScalar (2*y) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == m+m

evalTest0_1b n m o
  | n /= 0 = evalScalar (-x) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) /= n -- should fail
  | otherwise = evalScalar (-x) (subs ([("x",n),("y",m),("z",o)],[],[],[],[])) == n
...
evalTest1_0 n a1 a2 a3 a4 a5 a6 = 
  let
    ...
    x1 = var1d size "X1"
  in 
    evalOneD (simplify $ x1) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[])) == U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6))
evalTest1_1 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x1 = var1d size "X1"
  in 
    evalOneD (simplify $ -x1)   (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[])) == U.listArray (0,size-1) (map (*(-1)) (a1:a2:a3:a4:a5:(replicate size a6)))
evalTest1_2 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x1 = var1d size "X1"
  in 
    evalOneD (simplify $ x1+x1) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[])) == U.listArray (0,size-1) (map (*2) (a1:a2:a3:a4:a5:(replicate size a6)))
evalTest1_3 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x1 = var1d size "X1"
  in 
    evalOneD (simplify $ x1+x1+x1) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[])) == U.listArray (0,size-1) (map (*3) (a1:a2:a3:a4:a5:(replicate size a6)))
evalTest1_4 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x1 = var1d size "X1"
  in 
    evalOneD (simplify $ 2.0 `scale` x1) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[])) == U.listArray (0,size-1) (map (*2) (a1:a2:a3:a4:a5:(replicate size a6)))
evalTest1_5 :: Int -> Int -> Int -> Double -> Double -> Double -> Double -> Double -> Double -> Bool
evalTest1_5 i n h a1 a2 a3 a4 a5 a6 = 
  let
    ...
    left = evalOneD (([(abs m,(abs m + abs o))],[size]) `crop` x1) (subs ([],[("X1",U.listArray (0,size-1) list)],[],[],[]))
    right = U.listArray (0,abs o) (take (1 + abs o) $ drop (abs m) list) :: U.UArray Int Double
  in
...
evalTest1_6 h j i a1 a2 a3 a4 a5 a6 = 
  let
    ...
    o = abs $ i `mod`10
    j' = abs $ j `mod` 10
    n = if m+o+j' == 0 then j' + 2 else j'
    size = m + o + n
    list = take o $ a1:a2:a3:a4:a5:[a6,a6+1..]
    x1 = var1d size "X1" 
    left = evalOneD (([(m,m+o-1)],[size]) `uncrop` x1) (subs ([],[("X1",U.listArray (0,o-1) list)],[],[],[]))
    right = U.listArray (0,size-1) ((replicate m 0) ++ list ++ (replicate n 0)) :: U.UArray Int Double
  in
    if left == right then True
...
evalTest1_7 n a1 a2 a3 a4 a5 a6 = 
  let
    ...
    x1 = var1d size "X1"
  in 
    evalOneD (xRe (x1 +: x1)) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[]))  == U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6))
evalTest1_8 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x1 = var1d size "X1"
  in 
    evalOneD (xIm (x1 +: x1)) (subs ([],[("X1",U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6)))],[],[],[]))  == U.listArray (0,size-1) (a1:a2:a3:a4:a5:(replicate size a6))
--evalTest1_9 = evalOneD (xRe (ft (x1 +: y1))) subs1
--evalTest1_10 = evalOneD (xIm (ft (x1 +: y1))) subs1
...
evalTest2_0 n a1 a2 a3 a4 a5 a6 = 
  ...
  in
    evalTwoD (simplify $ x2) ((subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[]))) == U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^2-6) a6)) 
evalTest2_1 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x2 = var2d (size,size) "X2"
  in
    evalTwoD (simplify $ -x2) (subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[])) == U.listArray ((0,0),(size-1,size-1)) (map negate (a1:a2:a3:a4:a5:(replicate (size^2-6) a6))) 
evalTest2_2 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x2 = var2d (size,size) "X2"
  in
    evalTwoD (simplify $ (x2+x2)) (subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[])) == U.listArray ((0,0),(size-1,size-1)) (map (*2) (a1:a2:a3:a4:a5:(replicate (size^2-6) a6))) 
evalTest2_3 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x2 = var2d (size,size) "X2"
  in
    evalTwoD (simplify $ x2+x2+x2) (subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[])) == U.listArray ((0,0),(size-1,size-1)) (map (*3) (a1:a2:a3:a4:a5:(replicate (size^2-6) a6))) 
evalTest2_4 n a1 a2 a3 a4 a5 a6 = 
  let
    size = 2 + (n `mod` 10)
    x2 = var2d (size,size) "X2"
  in
    evalTwoD (simplify $ (2.0 `scale` x2)) (subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[])) == U.listArray ((0,0),(size-1,size-1)) (map (*2) (a1:a2:a3:a4:a5:(replicate (size^2-6) a6))) 
...
evalTest2_7 n a1 a2 a3 a4 a5 a6 = 
  let
    ...
    x2 = var2d (size,size) "X2"
  in
    evalTwoD (xRe (x2 +: x2)) (subs ([], [], [("X2",U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:((replicate (size^2-6) a6))))],[],[])) == U.listArray ((0,0),(size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^2-6) a6)) 
...
evalTest3_0 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (simplify $ x3) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (a1:a2:a3:a4:a5:(replicate (size^3-6) a6))
evalTest3_1 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (simplify $ -x3) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (map negate (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))
evalTest3_2 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (simplify $ (x3+x3)) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (map (*2) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))
evalTest3_3 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (simplify $ (x3+x3+x3)) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (map (*3) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))
evalTest3_4 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (simplify $ 2.0 `scale` x3) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (map (*2) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))
evalTest3_5 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (([(1,15),(1,15),(1,15)],[16,16,16]) `crop` x3) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(14,14,14))  (replicate (15^3) 1)
evalTest3_6 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (([(1,15),(0,15),(0,15)],[16,16,16]) `uncrop` x3) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1)) ((replicate (16^2) 0)++(replicate (15*16^2) 1))
evalTest3_7 n a1 a2 a3 a4 a5 a6 = 
  let
    x3 = var3d (size,size,size) "X3"
    size = 2 + (n`mod`10)
  in
    evalThreeD (xRe (x3 +: x3)) (subs ([],[],[], [("X3", U.listArray ((0,0,0),(size-1,size-1,size-1)) (a1:a2:a3:a4:a5:(replicate (size^3-6) a6)))],[])) == U.listArray ((0,0,0),(size-1,size-1,size-1))  (a1:a2:a3:a4:a5:(replicate (size^3-6) a6))
...
display1d a = let
    ...
    l = [a ! i | i <- [0..b] ] 
  in
    putStrLn (concat  $ List.intersperse "\t"  $ map show l)
  
display2d :: U.UArray (Int,Int) Double -> IO () 
display2d a = let
    ((_0,_0'),(b1,b2)) = bounds a
    l = [[a ! (i,j) | j <- [0..b2] ]| i <- [0..b1]] 
  in
    putStrLn (concat $ concat $ List.intersperse (["\n"]) $ map (List.intersperse "\t")  $ map (map show) l)

display3d :: U.UArray (Int,Int,Int) Double -> IO () 
display3d a = let
    ((_0,_0',_0''),(b1,b2,b3)) = bounds a
    l = [[[a ! (i,j,k) | k <- [0..b3] ]| j <- [0..b2]] | i <- [0..b1]] 
  in
...
regressionTestPartDiffZero = sequence [putStrLn "partDiffTest0_0", quickCheck partDiffTest0_0
        ...
        , putStrLn "partDiffTest0_3", quickCheck partDiffTest0_3
        , putStrLn "partDiffTest0_4", quickCheck partDiffTest0_4
        , putStrLn "partDiffTest0_5", quickCheck partDiffTest0_5
        , putStrLn "partDiffTest0_6", quickCheck partDiffTest0_6
        , putStrLn "partDiffTest0_7", quickCheck partDiffTest0_7
        , putStrLn "partDiffTest0_8", quickCheck partDiffTest0_8
        , putStrLn "partDiffTest0_9", quickCheck partDiffTest0_9
        ]

regressionTestPartDiffOne = sequence [putStrLn "partDiffTest1_2", quickCheck partDiffTest1_2
                              , putStrLn "partDiffTest1_3", quickCheck partDiffTest1_3
                              , putStrLn "partDiffTest1_4", quickCheck partDiffTest1_4
                              , putStrLn "partDiffTest1_5", quickCheck partDiffTest1_5
                              , putStrLn "partDiffTest1_6", quickCheck partDiffTest1_6
                              , putStrLn "partDiffTest1_7", quickCheck partDiffTest1_7
                              ]
...
partDiffTest0_1 b n = classify (n == 0 && b < 0)  "trivial" (
  if (n == 0 && b < 0) then  True
  else abs (evalScalar ((simplify (partDiff (p "x") ((sin x)^^b))) 
                     - (simplify ((cos x)*(fromIntegral b)*((sin x)^^(b-1))))) (subs ([("x",n)],[],[],[],[]))) <= 
...
partDiffTest0_2 b n = classify (n == 0 && b < 0) "trivial" (
  if n == 0 && b < 0 then  True
  else abs (evalScalar (simplify (partDiff (p "x") ((cos x)^^b))
                               - (negate (fromIntegral b)*(sin x)*((cos x)^^(b-1)))) (subs ([("x",n)],[],[],[],[]))) <= 
...
partDiffTest0_7 b n = classify (n == 0 && b <= 0) "trivial" (
  if (n == 0 && b < 0) then  True
  else abs (evalScalar (simplify (partDiff (p "x") ((sinh x)^^b)
                               - (sinh x)^^(b-1)*(fromIntegral b)*(cosh x))) (subs ([("x", seventyDouble n)],[],[],[],[]))) <= 
 0.0001*abs(evalScalar (simplify ((sinh x)^^(b-1)*(fromIntegral b)*(cosh x))) (subs ([("x",seventyDouble n)],[],[],[],[]))))
...
partDiffTest0_8 b n = (evalScalar (simplify (partDiff (p "x") ((cosh x)^^b)
            ...
            0.0001*abs(evalScalar (simplify ((cosh x)^^(b-1)*(fromIntegral b)*(sinh x))) (subs ([("x",seventyDouble n)],[],[],[],[])))
...
partDiffTest0_9 b n = classify (n < -325 || n > 325 || (n == 0 && b <= 0))  "trivial" (
  ...
  else abs (evalScalar (simplify (partDiff (p "x") ((tanh x)^^b))) (subs ([("x",n)],[],[],[],[])) 
          - evalScalar (simplify ((tanh x)^^(b-1)*(fromIntegral b)/(cosh x)^2)) (subs ([("x",n)],[],[],[],[]))) <= 
 0.0001*abs(evalScalar (simplify ((tanh x)^^(b-1)*(fromIntegral b)/(cosh x)^2)) (subs ([("x",n)],[],[],[],[]))))
...
partDiffTest1_2_1 n =
  [(evalScalar (simplify (partDiff (p "x") ( ( (log x) * (((x ^ 4) - 1) ^ 3))/(3 * (x ^ 2) ) ))) (subs ([("x",n)],[],[],[],[])))
...
partDiffTest1_3 n 
  | n == 0 = True
  | n == 1 = True
  | otherwise = abs ((evalScalar (simplify (partDiff (p "x") (((x^4) + (x^3))/((x^2) - x)))) (subs ([("x",n)],[],[],[],[])))
                   - (evalScalar (simplify ((2 * x * ((x ^ 2) - x - 1))/((x - 1) ^ 2))) (subs ([("x",n)],[],[],[],[])))) <= 0.01 * ((abs n) 
           + (abs (evalScalar (simplify (partDiff (p "x") (((x^4) + (x^3))/((x^2) - x)))) (subs ([("x",n)],[],[],[],[])))) + 1)

partDiffTest1_3_1 n =
  [(evalScalar (simplify (partDiff (p "x") (((x^4) + (x^3))/((x^2) - x)))) (subs ([("x",n)],[],[],[],[])))
...
partDiffTest1_7 (Positive n) = classify (n >= 11.8156233442122) "trivial" (
  if n >= 11.8156233442122 then True
                   ...
                   - (evalScalar (simplify ( ((4 * exp (4 * x * (x + 3))) * ((x * ((2 * x) + 3) * (log (4 * (x ^ 4)))) - 1))/(x * ((log (4 * (x ^ 4)) ^ 2)) ))) (subs ([("x",n)],[],[],[],[])))) <= 0.001 * ((abs n) + (abs (evalScalar (simplify (partDiff (p "x") ( (exp (4*x*(x+3)) )/(log (4*(x^4)) ) ))) (subs ([("x",n)],[],[],[],[])))) + 1))

partDiffTest1_7_1 n =
  [(evalScalar (simplify (partDiff (p "x") ( (exp (4*x*(x+3)) )/(log (4*(x^4)) ) ))) (subs ([("x",n)],[],[],[],[])))
