...
-- | 
--
evaluate1DReal :: ValMaps -> Expression d R -> Array Int Double
evaluate1DReal valMap e@(Expression n mp)
...
-- | 
--
evaluate1DComplex :: ValMaps -> Expression d C -> Array Int (Complex Double)
evaluate1DComplex valMap e@(Expression n mp)
    | [size] <- retrieveShape n mp =
...
-- | 
--
evaluate2DReal :: ValMaps -> Expression d R -> Array (Int, Int) Double
evaluate2DReal valMap e@(Expression n mp)
    | [size1, size2] <- retrieveShape n mp =
        let fmap :: (a -> c) -> Array (Int, Int) a -> Array (Int, Int) c
            ...
            foldl1' ::
                   (a -> a -> a) -> [Array (Int, Int) a] -> Array (Int, Int) a
            foldl1' f [x] = x
            foldl1' f (x:xs) = zipWith f x (foldl1' f xs)
         in case retrieveNode n mp of
                Var name ->
...
--
evaluate2DComplex ::
       ValMaps -> Expression d C -> Array (Int, Int) (Complex Double)
evaluate2DComplex valMap e@(Expression n mp)
    | [size1, size2] <- retrieveShape n mp =
        let fmap :: (a -> c) -> Array (Int, Int) a -> Array (Int, Int) c
            fmap f arr =
                listArray
...
evaluate3DReal :: ValMaps -> Expression d R -> Array (Int, Int, Int) Double
evaluate3DReal valMap e@(Expression n mp)
...
evaluate3DComplex ::
       ValMaps -> Expression d C -> Array (Int, Int, Int) (Complex Double)
evaluate3DComplex valMap e@(Expression n mp)
    | [size1, size2, size3] <- retrieveShape n mp =
        let fmap ::
                   (a -> c)
                -> Array (Int, Int, Int) a
