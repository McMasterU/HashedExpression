...
-- @
fromSubstitution :: HasCallStack => Substitution -> ((ExpressionMap, NodeID) -> ExpressionDiff)
...
--   found in a 'Match'
buildFromPattern :: HasCallStack => (ExpressionMap, NodeID) -> Match -> Pattern -> ExpressionDiff
