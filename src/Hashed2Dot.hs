...
threeDC2dot fileName (ThreeDC (Expression n e)) = writeFile fileName $ expr2dot' (e,n)
threeD2dot fileName (ThreeD (Expression n e)) = writeFile fileName $ expr2dot' (e,n)
scalar2dot fileName (Scalar (Expression n e)) = writeFile fileName $ expr2dot' (e,n)
expr2dot' (e,n) = 
  unlines $ ["digraph fmaSPU {", -- }
  " nslimit=\"100\";",
  " mclimit=\"100\";",
  " ranksep=\"0.4\";",
...
node2dot e ns n = if Set.member n ns 
                       then (ns,[])
                         ...
                         in case I.lookup n e of
                              ...
                              Just (Op _ op inputs) -> 
                                let uniqueInputs = L.nub $ L.sort inputs
                                    (nsNew,ls) = L.mapAccumR (node2dot e) nns uniqueInputs
                                in (nsNew, (nnl n (showOp op)) : 
